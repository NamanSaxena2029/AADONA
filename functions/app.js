...
const RelatedProduct =
  mongoose.models.RelatedProduct || mongoose.model("RelatedProduct", RelatedProductSchema);
...
app.get("/products/:slug/datasheet", async (req, res) => {
  try {
    ...
    doc
      .fontSize(12)
      .font("Helvetica")
      .text(product.overview?.content || product.description, { align: "justify" });
    doc.moveDown(1.5);
    ...
    doc
      .fontSize(10)
      .fillColor("gray")
      .text("Generated automatically from AADONA Product System", { align: "center" });
    doc.end();
  } catch (err) {
