...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
  ...
  /* Cover and back cover — fixed height */
  .page-fixed {
    display: block;
    width: 794px;
    height: 1123px;
  ...
  /* Content page — auto height, allows multi-page */
  .page-content {
    display: block;
    width: 794px;
    min-height: 1123px;
  ...
  /* Prevent spec tables from breaking mid-row */
  table { page-break-inside: avoid; break-inside: avoid; }
  tr { page-break-inside: avoid; break-inside: avoid; }

  /* Each spec section stays together */
  .spec-section { page-break-inside: avoid; break-inside: avoid; }
</style>
</head>
<body>
    ...
    <div style="display:table-row;">
      <div style="display:table-cell;">
        ...
        <div style="padding:36px 52px 20px 58px;">
          ${product.series ? `<div style="font-family:Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#25a86a;margin-bottom:12px;">${product.series}</div>` : ""}
          <div style="font-family:Arial,sans-serif;font-size:42px;font-weight:900;color:#ffffff;line-height:1.05;letter-spacing:-1px;">${product.model || product.name}</div>
          ${product.description ? `<div style="font-family:Arial,sans-serif;font-size:14px;color:rgba(255,255,255,0.45);margin-top:10px;line-height:1.5;">${product.description}</div>` : ""}
      ...
      <div style="display:table-cell;">
        <div style="display:table;width:100%;padding:0 52px 20px 52px;border-top:0.5px solid rgba(255,255,255,0.06);">
          <div style="display:table-cell;vertical-align:bottom;text-align:right;padding-top:16px;">
            <img src="data:image/png;base64,${makeIndia}" style="width:100px;opacity:0.80;" />
          </div>
        </div>
        <div style="height:68px;background:rgba(0,0,0,0.55);border-top:0.5px solid rgba(255,255,255,0.07);display:table;width:100%;padding:0 48px;">
          ...
          <div style="display:table-cell;vertical-align:middle;text-align:right;">
            <div style="font-family:Arial,sans-serif;font-size:9px;font-weight:700;letter-spacing:2.5px;color:rgba(37,168,106,0.60);text-transform:uppercase;">Product Datasheet</div>
          </div>
        </div>
      </div>
    </div>
...
<div class="page-content">
  ...
  <div style="display:table;width:794px;height:52px;background:#f4f9f4;border-bottom:0.5px solid #d8ead8;padding:0 64px;">
    ...
    <div style="display:table-cell;vertical-align:middle;text-align:right;">
      <div style="font-family:Arial,sans-serif;font-size:9px;font-weight:700;letter-spacing:2px;color:#1b7f4c;text-transform:uppercase;">${product.model || product.name}</div>
    </div>
  </div>
  ...
  <div style="padding:40px 64px 80px 64px;">
    ...
    <div style="margin-bottom:36px;page-break-inside:avoid;">
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px;">
        ...
        <div style="font-family:Arial,sans-serif;font-size:16px;font-weight:800;color:#1b7f4c;letter-spacing:0.3px;">Product Overview</div>
      </div>
    ...
    <div style="margin-bottom:36px;page-break-inside:avoid;">
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px;">
        <div style="width:4px;height:20px;background:linear-gradient(180deg,#25a86a,#1b7f4c);border-radius:2px;"></div>
        <div style="font-family:Arial,sans-serif;font-size:16px;font-weight:800;color:#1b7f4c;letter-spacing:0.3px;">Key Features</div>
      </div>
    ...
    <div style="page-break-inside:avoid;">
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
        <div style="width:4px;height:20px;background:linear-gradient(180deg,#25a86a,#1b7f4c);border-radius:2px;"></div>
        <div style="font-family:Arial,sans-serif;font-size:16px;font-weight:800;color:#1b7f4c;letter-spacing:0.3px;">Technical Specifications</div>
      </div>
      ${specsHTML}
    </div>` : ""}
  ...
  <!-- Bottom accent bar — sticks to bottom of last content page -->
  <div style="height:5px;background:linear-gradient(90deg,#1b7f4c,#25a86a 50%,#1b7f4c);"></div>
      ...
      <div style="display:table-cell;border-top:0.5px solid rgba(255,255,255,0.10);padding:28px 54px 20px 54px;">
        <div style="display:table;width:100%;">
          <div style="display:table-cell;width:46%;vertical-align:top;">
            <div style="font-family:Arial,sans-serif;font-size:12px;font-weight:700;color:rgba(255,255,255,0.85);margin-bottom:3px;">AADONA Communication Pvt Ltd</div>
            <div style="font-family:Arial,sans-serif;font-size:9px;font-weight:600;color:#25a86a;letter-spacing:1px;text-transform:uppercase;margin-bottom:10px;">Corporate Headquarters</div>
          ...
          <div style="display:table-cell;width:46%;vertical-align:top;">
            <div style="font-family:Arial,sans-serif;font-size:12px;font-weight:700;color:rgba(255,255,255,0.85);margin-bottom:3px;">AADONA Communication Pvt Ltd</div>
            <div style="font-family:Arial,sans-serif;font-size:9px;font-weight:600;color:#25a86a;letter-spacing:1px;text-transform:uppercase;margin-bottom:10px;">Production, Warehousing &amp; Billing</div>
            <div style="font-size:11.5px;color:rgba(255,255,255,0.48);line-height:1.95;">
    ...
    <div style="display:table-row;">
      <div style="display:table-cell;">
        ...
        <div style="height:68px;background:rgba(0,0,0,0.55);border-top:0.5px solid rgba(255,255,255,0.07);display:table;width:100%;padding:0 54px;">
          ...
          <div style="display:table-cell;vertical-align:middle;text-align:right;">
            <div style="font-family:Arial,sans-serif;font-size:9px;font-weight:700;letter-spacing:2.5px;color:rgba(37,168,106,0.55);text-transform:uppercase;">www.aadona.com</div>
          </div>
        </div>
      </div>
    </div>
