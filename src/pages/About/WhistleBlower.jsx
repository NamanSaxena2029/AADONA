...
const WhistleBlower = () => {
  ...
  return (
    <>
      {/* ✅ SEO ADDED */}
      <Helmet>
        <title>Whistle Blower | AADONA</title>

        <meta
          name="description"
          content="Report unethical practices securely to AADONA. We ensure transparency, ethics, and integrity in all operations."
        />

        <meta
          name="keywords"
          content="AADONA whistle blower, report misconduct, corporate ethics, integrity policy"
        />

        <meta property="og:title" content="Whistle Blower | AADONA" />
        <meta
          property="og:description"
          content="Securely report issues and unethical practices to AADONA."
        />
      ...
      <div className="bg-gradient-to-r from-green-700 to-green-900 pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p
            ...
            aria-label="Whistle blower description"
          >
      ...
      >
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 mt-16 pb-20 space-y-10">
          ...
          <div className="text-center">
            <Link
              to="/whistleButton"
              aria-label="Open whistle blower form"
            >
