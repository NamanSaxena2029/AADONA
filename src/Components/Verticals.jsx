...
function Card({ card }) {
  ...
  return (
    ...
    >
      ...
      <img
        src={card.image}
        alt={`${card.name} IT solutions sector`}
        loading="lazy"
...
export default function App() {
  return (
    <>
      {/* ✅ SEO (invisible) */}
      <Helmet>
        <title>Key Markets | AADONA</title>
        <meta
          name="description"
          content="Explore AADONA key markets including enterprise, government, healthcare, retail, and smart city solutions."
        />
        <meta
          name="keywords"
          content="AADONA markets, enterprise IT, government IT, healthcare IT, smart city, retail solutions"
        />
      </Helmet>
