...
const CertCard = ({ certUrl, index }) => {
  ...
  return (
    ...
    >
      <img
        src={certUrl}
        alt={`AADONA certification ${index + 1}`}
        loading="lazy"
...
const Certifications = () => {
  ...
  return (
    <>
      {/* ✅ SEO (invisible) */}
      <Helmet>
        <title>Certifications | AADONA</title>
        <meta
          name="description"
          content="AADONA certifications including ISO, MSME, DPIIT, and other recognized standards."
        />
        <meta
          name="keywords"
          content="AADONA certifications, ISO certified, MSME, DPIIT, IT company India"
        />
      </Helmet>
