...
const CountUp = ({ target, label, icon, orbBg, tickColor, duration = 1500 }) => {
  ...
  return (
    ...
    >
      ...
      {/* ✅ semantic strong for SEO (no UI change) */}
...
function CounterSection() {
  return (
    <>
      {/* ✅ SEO (invisible) */}
      <Helmet>
        <title>Our Achievements | AADONA</title>
        <meta
          name="description"
          content="AADONA achievements including customers, products, and trusted partners across India."
        />
        <meta
          name="keywords"
          content="AADONA achievements, customers, products, partners, IT company India"
        />
      </Helmet>
      ...
      <section className="bg-white overflow-hidden">
        <div className="bg-white px-8 pt-20 pb-6 text-center">
          ...
          {/* ✅ keep same design but semantic safe */}
